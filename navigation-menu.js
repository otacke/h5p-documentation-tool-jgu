var H5P = H5P || {};
H5P.DocumentationToolJGU = H5P.DocumentationToolJGU || {};

/**
 * Naivgation Menu module
 * @external {jQuery} $ H5P.jQuery
 */
H5P.DocumentationToolJGU.NavigationMenu = (function ($, EventDispatcher) {
  ...
  NavigationMenu.prototype.attach = function ($container) {
    ...
    this.docTool.pageInstances.forEach(function (page, pageIndex) {
      ...
      H5P.DocumentationToolJGU.handleButtonClick($navigationMenuEntry, function (event) {
        self.$documentationToolContaner.removeClass('expanded');
  ...
  NavigationMenu.prototype.updateNavigationMenu = function (currentPageIndex) {
    ...
    if (this.highlightIncompletePages === false) {
      if (self.docTool.pageInstances[currentPageIndex].libraryInfo.machineName === 'H5P.DocumentExportPageJGU') {
